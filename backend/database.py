...
# Database URL from environment (default to local SQLite for dev to avoid 500s when Postgres isn't running)
DATABASE_URL = os.getenv("DATABASE_URL", f"sqlite:///{os.path.join(os.path.dirname(__file__), 'app.db')}")
